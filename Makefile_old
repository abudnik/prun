...
COMMON_MASTER := log daemon config protocol defines ping node_ping job worker job_manager worker_manager scheduler job_sender result_getter timeout_manager admin
