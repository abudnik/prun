...
COMMON_MASTER := log daemon config protocol defines ping node_ping job worker job_manager worker_manager sheduler job_sender result_getter job_timeout admin
